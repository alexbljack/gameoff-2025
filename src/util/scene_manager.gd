...
@onready var fader: PackedScene = preload("res://src/util/fader/fader.tscn")
@onready var level_scene: PackedScene = preload("uid://ce4f4u57jqa5y")
@onready var title_scene: PackedScene = preload("uid://crvwdmp05ujb8")
